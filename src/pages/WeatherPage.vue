    ...
    <q-page>
      <q-card class="weather-card">
        <q-card-section>
          ...
          <div class="text-h6" style="border-radius: 8px;">Perkiraan Cuaca Hari Ini!!!!</div>
        </q-card-section>
...
.search-button {
  padding: 5px 15px;
  background-color: #FFC0CB; /* Button color */
  color: black !important; /* Ensure text is white and visible */
}
</style>
